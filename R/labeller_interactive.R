...
#' @param default_labeller a Labeller function, see [label_value()]
#' @examples
#' library(ggplot2)
#' library(ggiraph)
#'
...
labeller_interactive <- function(custom_label_func, default_labeller = ggplot2::label_value) {
  ...
  fun <- function(label_df) {
    ...
    labels <- default_labeller(label_df)
    # call user function
