...
DSVG_ <- function(file, width, height, bg, pointsize, standalone, canvas_id, clip_id_root, aliases) {
    .Call(`_ggiraph_DSVG_`, file, width, height, bg, pointsize, standalone, canvas_id, clip_id_root, aliases)
}
