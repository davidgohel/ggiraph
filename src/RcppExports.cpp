...
// DSVG_
bool DSVG_(std::string file, double width, double height, std::string bg, int pointsize, bool standalone, std::string canvas_id, std::string clip_id_root, Rcpp::List aliases);
RcppExport SEXP _ggiraph_DSVG_(SEXP fileSEXP, SEXP widthSEXP, SEXP heightSEXP, SEXP bgSEXP, SEXP pointsizeSEXP, SEXP standaloneSEXP, SEXP canvas_idSEXP, SEXP clip_id_rootSEXP, SEXP aliasesSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::string >::type clip_id_root(clip_id_rootSEXP);
    Rcpp::traits::input_parameter< Rcpp::List >::type aliases(aliasesSEXP);
    rcpp_result_gen = Rcpp::wrap(DSVG_(file, width, height, bg, pointsize, standalone, canvas_id, clip_id_root, aliases));
