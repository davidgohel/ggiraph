...
Now let's add an hover effect.

> elements associated with a `data_id` will be animated when mouse will be hover.
...
# htmlwidget call
ggiraph(code = {print(gg_point_2)}, width = 1, width_svg = 10, height_svg = 6,
