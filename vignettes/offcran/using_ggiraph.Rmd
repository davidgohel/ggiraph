...
x <- girafe_options(x = x,
    opts_tooltip(opacity = .8, css = "color:white;font-weight:bold;padding:2px;border-radius:2px;", use_fill = TRUE),
...
With `ggiraph`, you can customize tooltip style, mouse hover effects, toolbarposition... 
