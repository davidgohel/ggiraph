...
# ggiraph widgets ---
ggiraph(fun=print, x = gg_path_1, hover_css = "{stroke-width:3px;}")
ggiraph(fun=print, x = gg_path_2, hover_css = "{stroke:orange;stroke-width:3px;}")
ggiraph(fun=print, x = gg_path_3, hover_css = "{stroke-width:10px;}")
