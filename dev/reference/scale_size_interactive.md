...
[`ggplot2::scale_size_discrete()`](https://ggplot2.tidyverse.org/reference/scale_size.html),
[`ggplot2::scale_size_binned()`](https://ggplot2.tidyverse.org/reference/scale_size.html),
[`ggplot2::scale_size_binned_area()`](https://ggplot2.tidyverse.org/reference/scale_size.html),
[`ggplot2::scale_size_date()`](https://ggplot2.tidyverse.org/reference/scale_size.html),
[`ggplot2::scale_size_datetime()`](https://ggplot2.tidyverse.org/reference/scale_size.html),
[`ggplot2::scale_size_ordinal()`](https://ggplot2.tidyverse.org/reference/scale_size.html)
and
