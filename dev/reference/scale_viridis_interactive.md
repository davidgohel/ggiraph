...
[`ggplot2::scale_colour_viridis_c()`](https://ggplot2.tidyverse.org/reference/scale_viridis.html),
[`ggplot2::scale_fill_viridis_c()`](https://ggplot2.tidyverse.org/reference/scale_viridis.html),
[`ggplot2::scale_colour_viridis_b()`](https://ggplot2.tidyverse.org/reference/scale_viridis.html),
[`ggplot2::scale_fill_viridis_b()`](https://ggplot2.tidyverse.org/reference/scale_viridis.html),
[`ggplot2::scale_colour_ordinal()`](https://ggplot2.tidyverse.org/reference/scale_viridis.html),
[`ggplot2::scale_fill_ordinal()`](https://ggplot2.tidyverse.org/reference/scale_viridis.html).
