...
[`ggplot2::scale_alpha_continuous()`](https://ggplot2.tidyverse.org/reference/scale_alpha.html),
[`ggplot2::scale_alpha_discrete()`](https://ggplot2.tidyverse.org/reference/scale_alpha.html),
[`ggplot2::scale_alpha_binned()`](https://ggplot2.tidyverse.org/reference/scale_alpha.html),
[`ggplot2::scale_alpha_ordinal()`](https://ggplot2.tidyverse.org/reference/scale_alpha.html),
[`ggplot2::scale_alpha_date()`](https://ggplot2.tidyverse.org/reference/scale_alpha.html),
[`ggplot2::scale_alpha_datetime()`](https://ggplot2.tidyverse.org/reference/scale_alpha.html).
