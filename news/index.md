...
- fix “Unknown or uninitialised column: `subgroup`” warning when using
  [`geom_segment_interactive()`](https://davidgohel.github.io/ggiraph/reference/geom_segment_interactive.md)
  or
  [`geom_path_interactive()`](https://davidgohel.github.io/ggiraph/reference/geom_path_interactive.md)
  with
...
- add interactive version of
  ...
  see
  [`geom_quasirandom_interactive()`](https://davidgohel.github.io/ggiraph/reference/geom_quasirandom_interactive.md).
...
- fix custom tooltip for `zoom_off` state in toolbar not being applied
  correctly.
- fix
  [`geom_ribbon_interactive()`](https://davidgohel.github.io/ggiraph/reference/geom_ribbon_interactive.md)
  hover behavior so all ribbon parts (upper, lower, fill) with same
  `data_id` react together.
- improve
  [`geom_line_interactive()`](https://davidgohel.github.io/ggiraph/reference/geom_path_interactive.md)
  and
  [`geom_path_interactive()`](https://davidgohel.github.io/ggiraph/reference/geom_path_interactive.md)
...
- fix regexpr pattern used in
  [`facet_wrap_interactive()`](https://davidgohel.github.io/ggiraph/reference/facet_wrap_interactive.md)
...
- defunct
  [`ggiraph()`](https://davidgohel.github.io/ggiraph/reference/ggiraph.md),
  [`ggiraphOutput()`](https://davidgohel.github.io/ggiraph/reference/ggiraphOutput.md)
  and
  [`renderggiraph()`](https://davidgohel.github.io/ggiraph/reference/renderggiraph.md).
...
- Now
  [`facet_wrap_interactive()`](https://davidgohel.github.io/ggiraph/reference/facet_wrap_interactive.md)
  or
  [`facet_grid_interactive()`](https://davidgohel.github.io/ggiraph/reference/facet_grid_interactive.md)
