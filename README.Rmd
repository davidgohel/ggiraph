...
# ggiraph (dev version `r packageVersion("ggiraph")`) <img src="man/figures/logo.png" align="right" width="120" />

[![Travis Build Status](https://travis-ci.org/davidgohel/ggiraph.svg?branch=master)](https://travis-ci.org/davidgohel/ggiraph)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/davidgohel/ggiraph?branch=master&svg=true)](https://ci.appveyor.com/project/davidgohel/ggiraph)
[![Coverage Status](https://img.shields.io/codecov/c/github/davidgohel/ggiraph/master.svg)](https://codecov.io/github/davidgohel/ggiraph?branch=master)
...
`ggiraph` is a tool that allows you to create dynamic ggplot graphs. This allows you 
to add tooltips, animations and JavaScript actions to the graphics.The package also 
...
* Call function `girafe` with the ggplot object so that the graph is translated as 
...
available; you can display a tooltip when the player's mouse is on a graphical element, 
...
zz <- paste0(
  "`", 
  objects( pattern ="^geom", 
           envir = as.environment("package:ggiraph")), 
  "()`", 
  collapse = ", " )
cat(zz)
```
...
link](https://stackoverflow.com/questions/tagged/ggiraph+r)\! I
